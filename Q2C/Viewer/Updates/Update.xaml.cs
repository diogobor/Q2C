...
namespace Q2C.Viewer.Updates
{
    ...
    public partial class Update : Window
    {
        ...
        private void Load_info()
        {
            try
            {
                current_version = Util.Util.GetAppVersion();
                Q2CVersion.Text = "Version: " + current_version;
            }
        ...
        public ReadRelease Connect(string _version = "")
        {
            ...
            return new ReadRelease("diogobor", "q2c", current_version);
        }
        ...
        private void HyperlinkDownload_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                if (stable_release != null)
                {
                    ...
                    download_file = Util.Util.KnownFolders.GetPath(Util.Util.KnownFolder.Downloads) + "\\Q2C_" + stable_release.version.Replace('.', '_') + "_64bit.msi";
        ...
        private void WebClient_DownloadFileCompleted(object? sender, System.ComponentModel.AsyncCompletedEventArgs e)
        {
            System.Windows.MessageBox.Show(
                        ...
                        download_file +
                        "'\n\nQ2C will be closed and the setup file will be started.",
